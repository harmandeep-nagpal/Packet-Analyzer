...
struct Connection {
    ...
    std::chrono::steady_clock::time_point first_seen; // When did we first see this flow?
    std::chrono::steady_clock::time_point last_seen;// When did we last see this flow?
