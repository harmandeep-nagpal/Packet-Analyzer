...
// This function decides which FP gets the packet.
int LoadBalancer::selectFP(const FiveTuple& tuple) {
    ...
    // converts that potentially huge hash value into a valid FP index.
...
// Simply loops through all Load Balancers and starts them.
