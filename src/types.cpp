...
// Application       Possible SNI patterns
// ------------------------------------------------
...
AppType sniToAppType(const std::string& sni) {
    ...
    // Does the SNI contain a known Google-related pattern?
    ...
    //They are different strings/patterns that commonly appear in the domain/SNI of that application.
