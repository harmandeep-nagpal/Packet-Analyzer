...
bool PacketParser::parseIPv4(const uint8_t* data, size_t len, 
    ...
    // Is IPv4 header smaller than 20 bytes? and "Does the captured packet actually contain the entire IPv4 header that the IHL claims exists?"
...
// This helps in making the flag readable in human-mode
